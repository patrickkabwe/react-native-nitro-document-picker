...
namespace margelo::nitro::nitrodocumentpicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrodocumentpicker/NitroDocumentPickerOptions;";
  ...
  public:
    ...
    static jni::local_ref<JNitroDocumentPickerOptions::javaobject> fromCpp(const NitroDocumentPickerOptions& value) {
      using JSignature = JNitroDocumentPickerOptions(jni::alias_ref<jni::JArrayClass<JNitroDocumentType>>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JBoolean>);
      static const auto clazz = javaClassStatic();
      ...
      return create(
        ...
        [&]() {
          ...
          for (size_t __i = 0; __i < __size; __i++) {
            ...
            auto __elementJni = JNitroDocumentType::fromCpp(__element);
